...
class _PlayerSetupPageState extends State<PlayerSetupPage> {
  ...
  void _goToScoreboard() {
    ...
    final players = _players.map((item) {
      final player = item is _PlayerItem
          ? item
          : _PlayerItem(name: item.toString(), gender: 'Pria');
              ...
              children: [
                ...
                if (_players.isNotEmpty)
                  ...List.generate(_players.length, (index) {
                    final playerData = _players[index];
                    final player = playerData is _PlayerItem
                        ? playerData
                        : _PlayerItem(
                            name: playerData.toString(),
                            gender: 'Pria',
                          );
                      ...
                      child: Row(
                        children: [
                          CircleAvatar(
                            ...
                            backgroundColor: matchSetup.sport.gradientColors[0]
                                .withOpacity(0.3),
                            foregroundColor: matchSetup.sport.gradientColors[0],
                            child: Text('${index + 1}'),
                          ),
                          const SizedBox(width: 12),
                          Expanded(
